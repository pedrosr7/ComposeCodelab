package thevoid.whichbinds.composecodelab.ui.components
...
@Composable
private fun VVBottomNavItemLayout(
    icon: @Composable BoxScope.() -> Unit,
    text: @Composable BoxScope.() -> Unit,
...
@Composable
fun VVBottomNavIndicator(
    strokeWidth: Dp = 2.dp,
    color: Color = VVTheme.colors.iconInteractive,
